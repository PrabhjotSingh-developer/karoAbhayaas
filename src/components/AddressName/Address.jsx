...
const Address = () => {
  return (
    <div className='mb-20'>
          <div className="name_address flex border-2 mt-8 gap-3 sm:flex-row w-[90%] sm:w-[90%] md:w-[80%] lg:w-[70%] mx-auto p-6  flex-col ">
          ...
          <div className="order w-[90%] sm:w-[90%] md:w-[80%] lg:w-[70%] border-2 mx-auto border-collapse p-6">
